// utils/validator.js
// Giống y chang thầy: validatedResult + các validator riêng
let { body, validationResult } = require('express-validator');

module.exports = {
    // Giống thầy: trả về mảng lỗi theo format {field: message}
    ...
    // Validator đăng ký - giống thầy dùng isStrongPassword
    RegisterValidator: [
    ...
    // Validator đổi mật khẩu - giống thầy ChangePasswordValidator
